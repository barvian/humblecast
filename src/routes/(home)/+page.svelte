...
<header class="relative pt-[clamp(theme(padding.5),4vw,theme(padding.10))] pb-[calc(theme(spacing.2xl)-theme(spacing.4))] bg-[#0f7Bf9]" on:mousemove={({ x, y }) => mouse = { x, y }}>
	<Noise {mouse} />
	<div class="container @container relative">
		<nav class="flex items-center mb-xl">
			<a href="/"><Logo /></a>
			<div class="hidden @5xl:flex gap-[2.5em] whitespace-nowrap font-medium text-lg [text-shadow:0_0_2px_rgba(0,0,0,0.25)] mx-auto">
			...
			<div class="hidden @5xl:flex whitespace-nowrap items-stretch">
				<span class="cursor-not-allowed group text-lg font-medium rounded-full block py-[0.65em] px-[1.5em] [box-shadow:inset_0_0_2px_rgba(0,0,0,0.15),inset_0_0_0_1px_white,0_0_2px_rgba(0,0,0,0.2)] relative overflow-hidden">
					<span class="block relative overflow-hidden">
						<span class="block group-hover:-translate-y-[108%] group-hover:skew-y-6 transition duration-250 [text-shadow:0_0_2px_rgba(0,0,0,0.25)]">Log in</span>
					</span>
					<div aria-hidden class="absolute p-[inherit] inset-0 opacity-0 group-hover:opacity-100 transition bg-white duration-250">
						<span class="block overflow-hidden">
							<span class="block skew-y-6 group-hover:skew-y-0 translate-y-full group-hover:translate-y-0 transition duration-250 text-gray-900">Log in</span>
						</span>
					</div>
				</span>
				<span class="flex items-center group transition-all gap-0 hover:gap-3 cursor-not-allowed text-lg font-medium bg-white rounded-full text-[#000322] py-[0.65em] px-[1.5em]">
					<span class="block relative overflow-hidden">
						<span class="block group-hover:-translate-y-[108%] group-hover:skew-y-6 transition duration-250">Sign up</span>
						<span aria-hidden class="absolute top-full left-0 skew-y-6 group-hover:skew-y-0 group-hover:-translate-y-full transition duration-250">Sign up</span>
					</span>
		...
		<div class="flex flex-wrap whitespace-nowrap items-stretch mt-lg">
			...
			<span class="flex mb-4 items-center group gap-3 transition-all hover:gap-5 cursor-not-allowed text-lg font-medium bg-white rounded-full text-[#000322] py-[0.75em] px-[1.5em]">
				<span class="block relative overflow-hidden">
			...
			<span class="cursor-not-allowed mb-4 group text-lg font-medium rounded-full block py-[0.75em] px-[1.5em] [box-shadow:inset_0_0_2px_rgba(0,0,0,0.15),inset_0_0_0_1px_white,0_0_2px_rgba(0,0,0,0.2)] relative overflow-hidden">
				<span class="block relative overflow-hidden">
				...
				<div aria-hidden class="absolute p-[inherit] inset-0 opacity-0 group-hover:opacity-100 transition bg-white duration-250">
					<span class="block overflow-hidden">
						<span class="block skew-y-6 group-hover:skew-y-0 translate-y-full group-hover:translate-y-0 transition duration-250 text-gray-900">Switch to Humblecast</span>
					</span>
				</div>
			</span>
			<div class="ml-auto mb-4 relative hidden @2xl:block" aria-hidden>
				<a href="#content" class="rounded-full group hover:scale-110 transition duration-250 shadow-[inset_0_0_0_2px_white] flex items-center justify-center aspect-square absolute top-0 right-0 h-full before:inset-0 before:absolute before:border-2 before:border-white/30 before:rounded-full before:animate-pulse hover:before:!opacity-0 before:transition before:duration-250 hover:before:animate-[none] before:pointer-events-none">
					<div class="absolute bg-white rounded-full inset-0 group-hover:opacity-0 transition duration-250" />
					<div class="relative">
						<Arrow class="h-3.5 rotate-90 text-gray-900 group-hover:translate-y-2 transition duration-200 group-hover:opacity-0" />
						<Arrow class="absolute h-full rotate-90 top-0 -translate-y-2 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition duration-200" />
					</div>
				</a>
			</div>
		</div>
	...
	<div class="container grid grid-cols-1 sm:grid-cols-2 gap-2xl items-start">
		<div class="flex items-stretch w-full max-sm:order-1">
			...
			<div class="rounded-full self-center flex-shrink-0 bg-white w-[19%] aspect-square flex items-center justify-center gap-[5%]">
				<div class="w-[5%] flex flex-col items-stretch h-1/3 animate-waveform"><div class="rounded-t-full aspect-square bg-gray-900 animate-waveform-inverse [animation-delay:inherit] origin-bottom translate-y-[1px]" /><div class="flex-1 bg-gray-900" /><div class="rounded-b-full aspect-square bg-gray-900 animate-waveform-inverse [animation-delay:inherit] origin-top -translate-y-[1px]" /></div>
				<div class="w-[5%] flex flex-col items-stretch h-1/5 animate-waveform [animation-delay:-0.25s]"><div class="rounded-t-full aspect-square bg-gray-900 animate-waveform-inverse [animation-delay:inherit] origin-bottom translate-y-[1px]" /><div class="flex-1 bg-gray-900" /><div class="rounded-b-full aspect-square bg-gray-900 animate-waveform-inverse [animation-delay:inherit] origin-top -translate-y-[1px]" /></div>
				<div class="w-[5%] flex flex-col items-stretch h-1/2 animate-waveform [animation-delay:-0.5s]"><div class="rounded-t-full aspect-square bg-gray-900 animate-waveform-inverse [animation-delay:inherit] origin-bottom translate-y-[1px]" /><div class="flex-1 bg-gray-900" /><div class="rounded-b-full aspect-square bg-gray-900 animate-waveform-inverse [animation-delay:inherit] origin-top -translate-y-[1px]" /></div>
				<div class="w-[5%] flex flex-col items-stretch h-1/6 animate-waveform [animation-delay:-0.75s]"><div class="rounded-t-full aspect-square bg-gray-900 animate-waveform-inverse [animation-delay:inherit] origin-bottom translate-y-[1px]" /><div class="flex-1 bg-gray-900" /><div class="rounded-b-full aspect-square bg-gray-900 animate-waveform-inverse [animation-delay:inherit] origin-top -translate-y-[1px]" /></div>
				<div class="w-[5%] flex flex-col items-stretch h-1/3 animate-waveform [animation-delay:-1s]"><div class="rounded-t-full aspect-square bg-gray-900 animate-waveform-inverse [animation-delay:inherit] origin-bottom translate-y-[1px]" /><div class="flex-1 bg-gray-900" /><div class="rounded-b-full aspect-square bg-gray-900 animate-waveform-inverse [animation-delay:inherit] origin-top -translate-y-[1px]" /></div>
			</div>
		...
		<div class="@container">
			<div class="grid grid-cols-1 @md:grid-cols-[1fr_min-content] items-center gap-6">
				...
				<div class="whitespace-nowrap self-start @md:mt-2 order-last @md:order-[unset]">
					...
					<div role="link" tabindex="0" on:mouseover={focusJoin} on:mouseout={blurJoin} on:focus={focusJoin} on:blur={blurJoin} class="inline-flex items-center align-middle gap-4 relative -ml-4 cursor-not-allowed group">
						<div class="bg-white flex items-center justify-center flex-shrink-0 group-hover:-translate-y-1.5 transition border-2 border-gray-900 w-10 aspect-square rounded-full overflow-hidden">
							<svg class="w-3" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
								<line x1="6" y1="0" x2="6" y2="12" stroke="black" stroke-width="2" vector-effect="non-scaling-stroke" />
								<line y1="6" x2="12" y2="6" stroke="black" stroke-width="2" vector-effect="non-scaling-stroke" />
							</svg>							
						</div>
						<span class="font-medium relative">
							<svg class="sr-only">
								<defs>
									<filter id="distortion-1">
										<feTurbulence type="fractalNoise" baseFrequency={$joinDistort} numOctaves="1" result="warp"></feTurbulence>
							...
							Join them
							<div class="bg-white [filter:url(#distortion-1)] [outline:120px_solid_transparent] left-0 right-0 -bottom-[0.2em] h-[1px] group-hover:translate-y-1 transition duration-500" />
						</span>
					</div>
				</div>
				<p>
