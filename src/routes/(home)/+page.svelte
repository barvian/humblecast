...
<header class="relative pt-[clamp(theme(padding.5),4vw,theme(padding.10))] pb-2xl bg-[#0f7Bf9]" on:mousemove={({ x, y }) => mouse = { x, y }}>
	<Noise {mouse} />
	<div class="container relative">
		<nav class="flex items-center mb-xl">
			<a href="/"><Logo /></a>
			<div class="flex gap-[2.5em] whitespace-nowrap font-medium text-lg [text-shadow:0_0_2px_rgba(0,0,0,0.25)] mx-auto">
			...
			<div class="flex whitespace-nowrap items-stretch">
				<span class="cursor-not-allowed text-lg font-medium border rounded-full block py-[0.65em] px-[1.5em] [text-shadow:0_0_2px_rgba(0,0,0,0.25)] [box-shadow:inset_0_0_2px_rgba(0,0,0,0.15),0_0_2px_rgba(0,0,0,0.2)]">
					Log in
				</span>
				<span class="cursor-not-allowed text-lg font-medium bg-white rounded-full text-[#000322] block py-[0.65em] px-[1.5em]">
					Sign up
				</span>
			</div>
		</nav>
		...
		<div class="flex whitespace-nowrap items-stretch mt-lg">
			<span class="flex items-center group gap-3 transition-all hover:gap-5 cursor-not-allowed text-lg font-medium bg-white rounded-full text-[#000322] block py-[0.65em] px-[1.5em]">
	...
	<div class="container grid grid-cols-2 gap-2xl items-start">
		<div class="flex items-stretch w-full">
			<div class="rounded-l-full bg-[#d4dcde] flex-1 relative overflow-hidden">
				<Image src={man} loading="eager" class="object-cover object-center w-full h-full absolute inset-0 [clip-path:inset(0_0_0_100%)] loaded:[clip-path:inset(0_-100%_0_0_round_999px)] translate-x-4 loaded:translate-x-0 loaded:opacity-100 opacity-0 ease-out-expo transition-all duration-1000" />
			</div>
			<div class="rounded-full self-center flex-shrink-0 bg-white w-[19%] aspect-square flex items-center justify-center gap-[5%]">
				...
				<div class="w-[5%] bg-gray-900 rounded-full h-1/5" />
				<div class="w-[5%] bg-gray-900 rounded-full h-1/2" />
				<div class="w-[5%] bg-gray-900 rounded-full h-1/6" />
				<div class="w-[5%] bg-gray-900 rounded-full h-1/3" />
			</div>
		...
		<div class="@container">
			<div class="grid grid-cols-1 @md:grid-cols-[1fr_min-content] items-center gap-6">
				...
				<div class="whitespace-nowrap self-start mt-2 order-last @md:order-[unset]">
					<div class="w-10 inline-block hover:-translate-y-1.5 transition align-middle relative bg-white border-2 border-gray-900 aspect-square rounded-full will-change-transform overflow-hidden"><Image src={girl} alt="User headshot" class="w-full h-full object-cover transition opacity-0 loaded:opacity-100 duration-500" /></div>
					<div class="w-10 inline-block -ml-4 hover:-translate-y-1.5 transition align-middle relative bg-white border-2 border-gray-900 aspect-square rounded-full will-change-transform overflow-hidden"><Image src={girl2} alt="User headshot" class="w-full h-full object-cover transition opacity-0 loaded:opacity-100 duration-500" /></div>
					<div class="inline-flex items-center align-middle gap-4 relative -ml-4 cursor-not-allowed group">
						...
						<span class="underline underline-offset-[0.35em] font-medium">Join them</span>
					</div>
				</div>
				<p>
